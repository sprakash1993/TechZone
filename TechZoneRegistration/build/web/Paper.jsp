...
<div id="container">
    ...
    <div id="menu">
        <ul>
            ...
            <li><a href="Registration.jsp"><span></span>Registration</a></li>
            <li><a href="college.jsp"><span></span>College List</a></li>
             <li><a href="PaperReg.jsp" class="current"><span></span>Paper List</a></li>            
    ...
    <div class="register">
        ...
        <h1 style="margin-left:15px">Prastuthi Paper Registration</h1>
      <form method="post" action="index.html">
      
          <div  class="reg_section personal_info">
      <h3>Paper ID</h3>
      <input type="text" name="paperid" id="pid" placeholder="Paper ID">
      <h3>Paper Name</h3>
      <input type="text" name="papername" id="pname" placeholder="Paper name">
     </div> 
    <br/>
      <p class="submit"><input type="submit" name="commit" value="submit"/>     
